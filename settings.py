...
mock_data = {
    '/track/shipments?': {
        "{'trackingNumber': '7777777770', 'service': 'express'}": {'shipments': [{'id': '7777777770', 'service': 'express', 'origin': {'address': {'addressLocality': '-'}, 'servicePoint': {'url': 'http://www.dhl.com/en/country_profile.html', 'label': 'Origin Service Area'}}, 'destination': {'address': {'addressLocality': '-'}, 'servicePoint': {'url': 'http://www.dhl.com/en/country_profile.html', 'label': 'Destination Service Area'}}, 'status': {'timestamp': '2023-10-05T10:13:00', 'location': {'address': {
